...
![](align="center" /img/alt.atheism.png)
...
A complete example of ContrXT usage is provided in the notebook ["ContrXT Demo"](/ContrXT%20Demo.ipynb) inside of the main repository folder. A notebook example with ML model training is also available in this repository, which can also be accessed in this [Google Colab notebook](https://colab.research.google.com/drive/1hb4KN0SYxdj9SaExqqFGmAXAIyUnBVnA?usp=sharing).
